...
export function marketVibe(input) {
    ...
    if (sector) {
        sectorOverlay = {
            sector_focus: sector,
            sector_vibe_delta: seededInt(sector + today, "sdelta", -15, 15) > 0
    ...
    const result = {
        ...
        grail_positioning_bias: vibeScore >= 65
...
//# sourceMappingURL=market-vibe.js.map