...
export function tickerSignals(input) {
    ...
    const direction = directionRaw > 0.6 ? "bullish" : directionRaw < 0.35 ? "bearish" : "neutral";
    const confidence = Math.round(seeded(ticker, "conf", 52, 94));
    const timeframes = ["1–3 days", "1–2 weeks", "1 month", "3 months"];
    ...
    const sectorSignalNote = sector === "technology"
...
//# sourceMappingURL=ticker-signals.js.map