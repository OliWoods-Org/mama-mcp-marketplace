...
// ── generate_post ────────────────────────────────────────────────────────────
server.tool("generate_post", "Generate platform-optimized social media post copy from a topic and tone", {
...
// ── content_calendar ─────────────────────────────────────────────────────────
server.tool("content_calendar", "Generate a week of social media post ideas tailored to your industry and posting frequency", {
...
// ── hashtag_optimizer ─────────────────────────────────────────────────────────
server.tool("hashtag_optimizer", "Generate a ranked, optimized set of hashtags for a social media post", {
...
// ── repurpose_content ─────────────────────────────────────────────────────────
server.tool("repurpose_content", "Transform long-form content into ready-to-post snippets for multiple platforms", {
...
// ── engagement_reply ──────────────────────────────────────────────────────────
server.tool("engagement_reply", "Generate a brand-voice reply to a comment or DM that builds engagement and community", {
